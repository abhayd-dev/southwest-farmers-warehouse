                            ...
                            <li>
                                <a href="{{ route('warehouse.stock-requests.index') }}"
                                    ...
                                    @if(isset($pendingRequestsCount) && $pendingRequestsCount > 0)
                                        <span class="badge bg-danger ms-1 float-end">{{ $pendingRequestsCount }}</span>
                                    @endif
                                </a>
                            </li>
                        </ul>
                ...
                <li>
                    <a href="#sidebarStores" data-bs-toggle="collapse"
                        ...
                        @if(isset($lowStockCount) && $lowStockCount > 0)
                             <span class="badge bg-warning text-dark ms-auto me-3" title="{{ $lowStockCount }} items low on stock">
