                                ...
                                <select name="market_id" class="form-select" onchange="this.form.submit()">
                                    ...
                                    @foreach ($markets as $market)
                                        <option value="{{ $market->id }}"
                                            {{ $selectedMarket && $selectedMarket->id == $market->id ? 'selected' : '' }}>
                                            {{ $market->name }}
                                        </option>
                                    @endforeach
                                </select>
                                        ...
                                        <tbody>
                                            @forelse($products as $product)
                                                @php
                                                    ...
                                                    $hasPromo =
                                                        $marketPrice &&
                                                        $marketPrice->promotion_price > 0 &&
                                                        $marketPrice->promotion_start_date &&
                                                        $marketPrice->promotion_end_date &&
                                                        now()->between(
                                                            $marketPrice->promotion_start_date,
                                                            $marketPrice->promotion_end_date,
                                                        );
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-semibold">
                                                        ...
                                                        @if ($hasPromo)
                                                            <br><span class="badge bg-danger rounded-pill"><i
                                                                    class="mdi mdi-tag"></i> Active Promo:
                            ...
                            <div class="modal-content">
                                <form action="{{ route('warehouse.market-prices.promo') }}" method="POST">
                                    ...
                                    <div class="modal-header bg-warning">
                                        <h5 class="modal-title fw-bold text-dark"><i class="mdi mdi-tag me-2"></i>Set
                                            Promotion</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" name="promotion_start_date" id="promo_start"
                                                class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">End Date & Time</label>
                                            <input type="datetime-local" name="promotion_end_date" id="promo_end"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="modal-footer bg-light">
                                        ...
                                        <button type="submit" class="btn btn-warning fw-bold text-dark">Save
                                            Promotion</button>
                                    </div>
                                </form>
                            </div>
