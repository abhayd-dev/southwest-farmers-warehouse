...
$(document).ready(function() {
    let table = $('#stockOverviewTable').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                d.department_id = $('#departmentFilter').val(); // Added
        ...
        columns: [
            ...
            { data: 'department_name', defaultContent: '-' }, // Added
    ...
    $('#departmentFilter, #subcategoryFilter, #lowStockFilter').change(() => table.draw());
});
</script>
@endpush
