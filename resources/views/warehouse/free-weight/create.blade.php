            ...
            <div class="col-12 col-lg-7">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('warehouse.free-weight.store') }}" method="POST"
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-8">
                                    <label class="form-label fw-semibold">Initial Bulk Weight <span
                                            class="text-danger">*</span></label>
                                    <input type="number" name="bulk_weight" step="0.01" min="0.01"
                                        class="form-control" value="{{ old('bulk_weight') }}" placeholder="e.g. 5000"
                                        required>
