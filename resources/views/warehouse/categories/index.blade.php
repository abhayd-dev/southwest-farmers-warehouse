                            ...
                            <form method="GET" class="d-flex flex-grow-1" style="max-width: 500px;">
                                <div class="input-group shadow-sm">
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        class="form-control border-end-0" placeholder="Search categories...">
                            ...
                            @forelse($categories as $category)
                                <tr class="border-bottom">
                                    ...
                                    <td class="py-3 fw-semibold">
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ $category->icon ? Storage::disk('r2')->url($category->icon) : asset('assets/images/placeholder.svg') }}"
                                    ...
                                    <td class="py-3"><code
                                            class="bg-light px-2 py-1 rounded">{{ $category->code }}</code></td>
                                    <td class="py-3 text-center"><span
                                            class="badge bg-info bg-opacity-10 text-info">{{ $category->subcategories_count }}</span>
                                    </td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold"><i class="mdi mdi-shape text-primary me-2"></i> Category Details
                    </h5>
