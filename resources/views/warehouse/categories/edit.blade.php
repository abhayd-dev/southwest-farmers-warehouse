<x-app-layout title="Edit Category">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form method="POST" action="{{ route('warehouse.categories.update', $category) }}"
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4 text-center">
                            <label for="iconInput" class="position-relative d-inline-block cursor-pointer">
                                <img id="iconPreview"
                                    src="{{ $category->icon ? Storage::disk('r2')->url($category->icon) : asset('assets/images/placeholder.svg') }}"
                                    class="rounded-circle border shadow-sm object-fit-cover" width="100"
                                    height="100" alt="Icon Preview">
                                <div
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Category Code <span
                                    class="text-danger">*</span></label>
