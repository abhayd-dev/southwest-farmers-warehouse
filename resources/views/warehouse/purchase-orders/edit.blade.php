<x-app-layout title="Edit Purchase Order">
    <div class="container-fluid">
        <form method="POST" action="{{ route('warehouse.purchase-orders.update', $purchaseOrder->id) }}" id="poForm">
            @csrf
            @method('PUT')
                ...
                <div class="py-3">
                    <div
                        ...
                        <div class="d-flex gap-2 w-100 w-md-auto justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary shadow-sm flex-fill flex-md-grow-0">
                                <i class="mdi mdi-content-save me-1"></i> Update Draft
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="vendor_notes" class="form-control" rows="4" placeholder="Optional instructions for vendor...">{{ $purchaseOrder->vendor_notes }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="approval_email" class="form-control border-start-0"
                                        placeholder="manager@example.com" value="{{ $purchaseOrder->approval_email }}">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" name="approver_phone" class="form-control border-start-0"
                                        placeholder="+1 234 567 8900" value="{{ $purchaseOrder->approver_phone }}">
                                </div>
                            </div>
                        </div>
                    </div>
