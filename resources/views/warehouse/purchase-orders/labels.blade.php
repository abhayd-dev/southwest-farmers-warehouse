                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td class="header-title"
                                                    style="border:none; padding:0; background:transparent;">Warehouse
                                                    Receipt</td>
                                                <td class="header-date"
                                                    style="border:none; padding:0; background:transparent;">REC:
                                                    {{ date('d-M-y') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td style="width: 55%; padding:0; border:none;">
                                                    ...
                                                    <div class="meta-value">
                                                        {{ Str::limit($purchaseOrder->vendor->name, 18) }}</div>
                                                </td>
