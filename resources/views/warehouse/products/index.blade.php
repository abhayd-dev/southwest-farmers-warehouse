                                    ...
                                    <td class="py-3">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $product->department->name ?? 'N/A' }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-warning text-dark border-0">
                    <h5 class="modal-title fw-bold"><i class="mdi mdi-currency-usd"></i> Set Pricing (Bulk Update)</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="{{ route('warehouse.products.bulk-price-update') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="modal-body p-4">
                        <div class="alert alert-warning d-flex align-items-start small">
                            <i class="mdi mdi-alert me-2 fs-5"></i>
                            <div>
                                This will <strong>increase</strong> the price of all products in the selected Category/Subcategory. 
                        ...
                        <div class="mb-3">
                            ...
                            <select name="subcategory_id" id="priceSubcategorySelect" class="form-select" disabled>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Increase Percentage (%) <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="number" name="percentage" class="form-control" min="0.01" step="0.01" placeholder="e.g. 10" required>
