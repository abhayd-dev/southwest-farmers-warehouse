                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border p-3 rounded text-center bg-light position-relative">
                                        <img src="{{ isset($settings['main_logo']) ? Storage::disk('r2')->url($settings['main_logo']) : asset('assets/images/placeholder.svg') }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border p-3 rounded text-center bg-light">
                                        <img src="{{ isset($settings['login_logo']) ? Storage::disk('r2')->url($settings['login_logo']) : asset('assets/images/placeholder.svg') }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="border p-3 rounded text-center bg-light">
                                        <img src="{{ isset($settings['favicon']) ? Storage::disk('r2')->url($settings['favicon']) : asset('assets/images/placeholder.svg') }}"
