                            ...
                            <tr>
                                <td class="px-4">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="{{ $user->profile_image ? asset($user->profile_image) : asset('assets/images/default-avatar.png') }}" class="rounded-circle border" width="45" height="45" style="object-fit: cover;">
                                        <div>
