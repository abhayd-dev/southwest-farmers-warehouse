<x-app-layout title="Edit Subcategory">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form method="POST" action="{{ route('warehouse.subcategories.update', $subcategory) }}"
                    enctype="multipart/form-data" class="card border-0 shadow-sm needs-validation" novalidate>
                    @csrf @method('PUT')
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4 text-center">
                            <label for="iconInput" class="position-relative d-inline-block cursor-pointer">
                                <img id="iconPreview"
                                    src="{{ $subcategory->icon ? Storage::disk('r2')->url($subcategory->icon) : asset('assets/images/placeholder.svg') }}"
                                    class="rounded-circle border shadow-sm object-fit-cover" width="100"
                                    height="100">
                                <div
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Parent Category <span
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Subcategory Code <span
                                    class="text-danger">*</span></label>
